...
note_load = YAML.load_file('note_frame.yml')
note_save = YAML::Store.new('note_frame.yml')

note_init = YAML.load_file('note_init.yml')
note_record = YAML::Store.new('note_init.yml')
cur_dir = note_init["cur_dir"]
require './add_action.rb'
